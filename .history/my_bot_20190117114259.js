...
async function countMessages(receivedMessage, fs){
    ...
    await levelingSystem(receivedMessage, userData, sender);
...
function levelingSystem(receivedMessage, userData, sender){
    console.log(userData[sender.id].messagesSent)
}
